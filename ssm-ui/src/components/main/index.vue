...
<template>
  ...
  <el-container>
        ...
        <el-row>
          <el-col :span="24">
            ...
            >
			  ...
			  <el-menu-item index="3" @click="open('log')">
			    <el-icon></el-icon>
			    <span>日志管理</span>
			  </el-menu-item>
            </el-menu>
      ...
      <el-container>
        <el-header >当前登录身份:<el-text class="mx-1" type="primary">{{nickname}}</el-text>
		<el-button type="warning" @click="doLogout">登出</el-button>
		</el-header>
        <!--进行路由跳转-->
        <el-main>
          <router-view />
